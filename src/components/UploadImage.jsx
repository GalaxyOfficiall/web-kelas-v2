...
function UploadImage() {
  ...
  // Menggantikan listAll + getDownloadURL dari Firebase Storage
  ...
  const uploadImage = async () => {
    ...
    // Upload ke Supabase Storage (menggantikan uploadBytes Firebase)
    ...
    // Dapatkan public URL (menggantikan getDownloadURL Firebase)
    const { data: urlData } = supabase.storage
      .from("images")
